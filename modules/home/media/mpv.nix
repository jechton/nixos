...
in
{
  ...
  programs.mpv = {
    ...
    config = {
      ...
      # video settings; prefer vulkan hardware decoding
      hwdec = "auto-copy";
      gpu-api = "vulkan";
      profile = "gpu-hq";
      ...
      screenshot-png-compression = 4; # 0 to 10, 0 being no compression
    ...
    profiles = {
      ...
      # good reference: https://github.com/Tsubajashi/mpv-settings
      video = {
    ...
    scriptOpts = {
      modernz = {
        # colors are themed by noctalia's own stylix-driven mpv target
        idlescreen = "no";
